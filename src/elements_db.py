...
def scan_query_for_elements(query: str) -> str:
    """Scans the user query for keywords and returns matched element directives. Only returns content when explicit keywords match."""
    query_lower = query.lower()
    directives = []
    
    categories = {
        "LAYOUTS": (LAYOUTS, "=== DESIGN LAYOUT ==="),
        "NAV_STYLES": (NAV_STYLES, "=== NAVIGATION STYLE ==="),
        "COLORS": (COLORS, "=== COLOR THEME ==="),
        "ANIMATIONS": (ANIMATIONS, "=== ANIMATIONS ==="),
        "STYLES": (STYLES, "=== DESIGN STYLE ==="),
        "EFFECTS": (EFFECTS, "=== EFFECTS ==="),
        "TYPOGRAPHY": (TYPOGRAPHY, "=== TYPOGRAPHY ==="),
        "BUTTONS": (BUTTONS, "=== BUTTON STYLES ==="),
        "HEROES": (HEROES, "=== HERO SECTION ==="),
        "FOOTERS": (FOOTERS, "=== FOOTER STYLE ==="),
        "SECTIONS": (SECTIONS, "=== SECTION COMPONENTS ==="),
        "HOVER_EFFECTS": (HOVER_EFFECTS, "=== HOVER EFFECTS ==="),
        "BACKGROUNDS": (BACKGROUNDS, "=== BACKGROUNDS ==="),
        "GRADIENTS": (GRADIENTS, "=== GRADIENTS ===")
    }

    for cat_name, (cat_dict, header) in categories.items():
        matched = []
    ...
    for industry_name, rules in INDUSTRIES.items():
        ...
        if any(re.search(r'\b' + re.escape(alias) + r'\b', query_lower) for alias in aliases if len(alias) >= 3):
    ...
    if directives:
        ...
        return "\n\n[MATCHED DESIGN DIRECTIVES FROM ELEMENTS DATABASE]\n" + "\n".join(directives) + "\n"
